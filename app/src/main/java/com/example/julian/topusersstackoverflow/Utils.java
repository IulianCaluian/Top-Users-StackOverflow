...
public final class Utils {
    ...
    public static List<Profile> fetchProfilesData(String requestUrl) {
        ...
        List<Profile> profiles = extractFeatureFromJson(jsonResponse);
    ...
    private static List<Profile> extractFeatureFromJson(String profilesJSON) {
